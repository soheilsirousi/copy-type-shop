...
class Order(models.Model):
    ...
    language = models.ForeignKey(Language, on_delete=models.RESTRICT, related_name='orders')
    input_format = models.ForeignKey(InputFormat, on_delete=models.RESTRICT, related_name='orders')
